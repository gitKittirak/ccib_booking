...
<body>
    ...
    <div id="content" class="p-4 p-md-5 pt-5">
        <h1 class="h3 mb-3 fw-normal text-center">สถานะการจองห้องประชุม, <br>คุณ<?php echo $row['firstname'] ?></br></h1><br>
        <table id="table" data-toggle="table" data-url="table_booking_user.php">
            <thead>
                <tr>
